...
export declare class MetaMaskWallet extends Wallet {
    ...
    addNetwork: ({ networkName, rpc, chainId, symbol }: import("@tenkeylabs/dappwright/src").AddNetwork) => Promise<void>;
    addToken: ({ tokenAddress, symbol, decimals }: import("@tenkeylabs/dappwright/src").AddToken) => Promise<void>;
    approve: () => Promise<void>;
    createAccount: () => Promise<void>;
    confirmNetworkSwitch: () => Promise<void>;
    confirmTransaction: (options?: import("@tenkeylabs/dappwright/src").TransactionOptions) => Promise<void>;
